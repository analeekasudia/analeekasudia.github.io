...
window.onload = function () {
  ...
  function makeRequest () {
    ...
    function responseMethod() {
        ...
        if (httpRequest.readyState === XMLHttpRequest.DONE) {
            ...
            if (httpRequest.status === 200) {
                ...
                // Uncomment if using Handlebars --> var data = JSON.parse(httpRequest.response)
                // Uncomment if using Handlebars --> populateData(data)
    ...
    /* Uncomment if using Handlebars; doublecheck placement if within scope/correct brackets
